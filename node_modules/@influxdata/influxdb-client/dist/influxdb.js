var influxdb = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  var WriteApiImpl = /** @class */ (function () {
      ...
      WriteApiImpl.prototype.sendBatch = function (lines, attempts, expires) {
          var _this = this;
          ...
          if (!this.closed && lines.length > 0) {
              if (expires <= Date.now()) {
                  ...
                  Logger.error("Write to InfluxDB failed (attempt: " + failedAttempts + ").", error);
                  ...
                  var callbacks = {
                      ...
                      error: function (error) {
                          ...
                          if (!self.closed &&
                              ...
                              Logger.warn("Write to InfluxDB failed (attempt: " + failedAttempts + ").", error);
                              self.retryBuffer.addLines(lines, attempts - 1, self.retryStrategy.nextDelay(error, failedAttempts), expires);
                              reject(error);
                              return;
                          }
